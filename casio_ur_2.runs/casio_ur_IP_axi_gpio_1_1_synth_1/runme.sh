...
HD_PWD='C:/vivado_projects/casio_ur_2/casio_ur_2.runs/casio_ur_IP_axi_gpio_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log casio_ur_IP_axi_gpio_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source casio_ur_IP_axi_gpio_1_1.tcl
