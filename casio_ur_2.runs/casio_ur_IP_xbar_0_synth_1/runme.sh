...
HD_PWD='C:/vivado_projects/casio_ur_2/casio_ur_2.runs/casio_ur_IP_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log casio_ur_IP_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source casio_ur_IP_xbar_0.tcl
