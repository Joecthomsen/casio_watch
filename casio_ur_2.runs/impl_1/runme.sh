...
HD_PWD='C:/vivado_projects/casio_ur_2/casio_ur_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log casio_ur_IP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source casio_ur_IP_wrapper.tcl -notrace
