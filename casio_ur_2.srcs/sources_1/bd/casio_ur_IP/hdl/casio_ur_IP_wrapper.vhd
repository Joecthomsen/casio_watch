...
--Command     : generate_target casio_ur_IP_wrapper.bd
--Design      : casio_ur_IP_wrapper
...
end casio_ur_IP_wrapper;

architecture STRUCTURE of casio_ur_IP_wrapper is
  component casio_ur_IP is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
casio_ur_IP_i: component casio_ur_IP
     port map (
